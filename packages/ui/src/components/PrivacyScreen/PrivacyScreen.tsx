    ...
    <Container maxWidth="sm">
      <div>
        ...
        <p>
          ...
          principles of the EU GDPR data protection act. By accessing this site
          you agree to the terms of this privacy policy and consent to the
          collection, processing, use or transfer of data as set out in this
          policy.
        </p>
        <p>
          <strong>
            THIS POLICY APPLIES TO OUR SERVICES AND ONLINE TOOLS, INCLUDING THE
            WEBSITE AND MOBILE APPLICATIONS, AND OTHER (COLLECTIVELY “THE
        ...
        <p>
          ...
          shall take necessary measures to ensure that such data is processed by
          the personal data processors in accordance with instructions of and
          applicable European Union legislation. Shall also require the personal
          data processors to implement appropriate measures for the security of
          personal data. In such cases, we shall ensure that such persons will
          be subject to the non-disclosure obligation and will no video calling
          and messaging t be able to use this information for any other purpose,
          except to the extent necessary to perform the functions assigned to
          them.
        </p>
        <ul>
        ...
        <p>
          ...
          connection of people through calling via our Application, and website.
        </p>
        <p>
          ...
          you on the App, is considered as your official consent to process your
          personal information, your consent to the collection, use, and
          disclosure of your personal information as described further below. We
          may request you to provide additional disclosures or information about
          the data processing practices of specific Services. These notices may
          supplement or clarify our privacy practices or may provide you with
          additional choices about how we process your data.
        </p>
        <p>
          ...
          of Sentrei Application and website and its related services.
        </p>
        <h2>3. Data Protection Principles</h2>
        <p>
          “Personal data” means any information that enables us to identify you
          or the beneficiary of your transaction with us, directly or
        ...
        <p>
          ...
          collect, process or store, with the purpose and that we have the legal
          ground to do so in accordance with the GDPR:
        </p>
        <p>
          ...
          collect and store the personal information you provide on the service.
        </p>
        <p>
        ...
        <p>
          <span>Anonymous Data.</span> Some of the non-personal Data that we are
          data that cannot identify, distinguish or trace you or your Device,
          even if combined with other identifying information, and some Data
          that could be considered PII when combined with other identifying
          information is not used in a way that identifies, distinguishes or
          traces you or your Device, but is instead used in an anonymous way,
          often aggregated with other anonymous Data about other users.
        </p>
        <h2>5. Personal Information We Collect About You (PIPEDA)</h2>
        <p>
          According to the personal information protection and electronic
          documents act, 2000 (PIPEDA), “personal information” means information
          about an identifiable individual. The information you provide to
          Sentrei is considered personal information it is possible to relate it
          back to you through your name, address, e-mail address, telephone
          number and any other information that can identify you. If information
          cannot be related to an identifiable individual it is considered
          anonymous information (such as laboratory results identified by
          alpha-numeric identifier instead of individual’s name). Whenever
          possible, Sentrei works with anonymous information. This privacy
          statement does not apply to anonymous information.
        </p>
        ...
        <ul>
          <li>
            ...
            date of birth, nationality, gender, photographs, phone number, home
            address, and/or email. Which certain jurisdictions consider to be
            PII because it could be used to identify an individual or Device if
            it were combined with other identifying information.
          </li>
          <li>
            2. <strong>Institutional Information:</strong> Employer
            Identification number (or comparable number issued by a government),
            proof of legal formation (e.g. Articles of Incorporation), personal
          ...
          <li>
            ...
            to purchase a paid version of the Services provide Whereby (and our
            payment processors) with billing details such as credit card
            ...
            may be processed for the purpose of supplying the purchased services
            and keeping proper records of those transactions. This data may be
            used for the purpose of delivering the Services to you. Processing
            this information is required for fulfilling the contract we entered
            into with you, at your request (our Terms of Service) cf. GDPR art.
            6 (1) item b. additionally, this information needs to be retained in
            order to comply with accounting and tax regulation cf. GDPR art. 6
            (1)
          </li>
          <li>
        ...
        <p>
          ...
          information or web site visitations). Sentrei may collect non-personal
          information through any of the methods discussed above as well as
          automatically through use of industry standard technologies described
          further below.
        </p>
        ...
        <p>
          ...
          non-personal information about your use of the Sentrei materials (e.g.
          Your internet browser, operating system, ip address, connection speed,
          and the domain name of your internet service provider). Such
        ...
        <ul>
          <li>
            ...
            browser on your device’s hard drive which work by assigning to your
            computer a unique number that has no meaning outside of the Sentrei
            site. Cookies do not generally contain any personal information.
            Most web browsers automatically accept cookies, but you can usually
            configure your browser to prevent this. Not accepting cookies may
            make certain features of the Sentrei materials unavailable to you.
          </li>
          <li>
          ...
          <li>
            ...
            links in those e-mails. The information from use of these technical
            methods may be collected in a form that&nbsp;constitutes personal
            information.
          </li>
          <li>
        ...
        <p>
          ...
          (e.g., browser type, operating system, and basic device information),
          the web page you visited or search query you entered before reaching
          us, and your activities. We may track your activities using cookies
          and similar technologies. By using our services, you agree to our use
          of these methods as set forth in our&nbsp;cookie policy.
        </p>
        <h2>11. Information We Collect From You Automatically</h2>
        <p>
          We receive and store certain types of information automatically, such
          as whenever you interact with or use Sentrei Application and website.
          This information helps us address customer support issues, improve the
          performance of Sentrei Application and website, providing you with a
          streamlined and personalized experience, and protect your account from
          fraud by detecting unauthorized access. Information collected
        ...
        <ul>
          ...
          <li>
            * How your device interacts with Sentrei Application and website and
            Services, including pages accessed and links clicked;
          </li>
          <li>
        ...
        <p>
          ...
          service and or App via an external link, such as a link appearing on a
          third party site
        </p>
        ...
        <ul>
          ...
          <li>
            * <strong>Communicating with you:</strong> we use your data when we
            communicate with you (e.g., when we respond to a customer support or
            other inquiry).
          </li>
          <li>
          ...
          <li>
            * <strong>Customizing your experience:</strong> we use your data to
            personalize the service to you. This may include remembering your
            preferences for language or volume or displaying app that you might
            enjoy, based upon your viewing choices.
          </li>
          <li>
            * <strong>To ensure network and data security:</strong> We process
            your personal information in order to enhance security, monitor and
            ...
            accurate and up-to-date information about your use of Sentrei
            Services.
          </li>
          <li>
          ...
          <li>
            * <strong>Exercising our rights:</strong> where reasonably
            necessary, we use your data to exercise our legal rights and prevent
            abuse of our service. For example, we may use your data to detect
            and prevent fraud, spam, or content that violates our terms of
            service.
          </li>
          <li>
          ...
          <li>
            * <strong>For research and development:</strong> We process your
            ...
            information to customize, measure, and improve Sentrei features and
            the content and layout of our App and applications, and to develop
            new services.
          </li>
        </ul>
        <p>
        ...
        <p>
          ...
          the fact that you have visited the App, to identify aspects of your
          usage of the App and combine that with what it knows about your usage
          of other Apps in the Google ad network.
        </p>
        <p>
          ...
          shared interests with visitors of our App. Google’s collection and use
          of your personal data is covered by the Google privacy policy. You can
          set preferences for how Google advertises to you using the Google Ad
          Preferences page.
        </p>
        ...
        <ul>
          <li>
            * <strong>With your consent:</strong> we may share your data with
            third parties where we have obtained your express consent to do so.
          ...
          <li>
            * <strong>Authorized vendors:</strong> we may share your data with
            ...
            email service providers, quality assurance and testing vendors,
            fraud and abuse prevention vendors, customer relations management
            (crm) vendors
          </li>
          <li>
            * <strong>Advertising:</strong> we may share your data with
            advertising companies to display relevant ads to you. Unless you
            expressly agree, we will not share or sell your name, email address,
            or physical address with such persons.
          </li>
          <li>
            * <strong>Analytics:</strong> we may share your data with persons
            who provide analytics showing how customers are using our services.
          </li>
          <li>
            * <strong>Affiliates and advisors:</strong> we may share your data
            ...
            and legal compliance. Unless you expressly agree, we will not share
            your data with our parent or any affiliate for other purposes, such
            as direct marketing.
          </li>
          <li>
            * <strong>Certain legal situations:</strong> we may share your data
            where we believe disclosure is necessary to comply with a legal
            obligation or in connection with a corporate transaction.
          </li>
          <li>
            * <strong>Aggregated or anonymized information:</strong> we may
            publicly disclose non-personal aggregated or anonymized information
            such as our number of visitors and registered users.
          </li>
        </ul>
        <h2>16. Mobile Devices</h2>
        <p>
          Sentrei may occasionally send you push notifications through our
          mobile applications. You may at any time opt-out from receiving these
          types of communications by changing the settings on your mobile
          device. We may also collect location-based information if you use our
          mobile applications. You may opt-out of this collection by changing
        ...
        <p>
          ...
          services. Please note that we do not respond to or honor DNT signals
        ...
        <p>
          ...
          your email address; your tax information; communications with you; and
          your transactional information (for auditing, tax, and financial
          purposes). When we no longer have a business reason for retaining
        ...
        <p>
          For individuals who are located in the European Economic Area, United
          Kingdom or Switzerland (collectively “EEA Residents”) at the time
          their personal data is collected, we rely on legal bases for
          ...
          where we are legally required to, where the processing is necessary to
          perform any contracts we entered with you (or to take steps at your
          request prior to entering into a contract with you), for our
          legitimate interests to operate our business or to protect Sentrei
          application and website or your, property, rights, or safety, or where
          we have obtained your consent to do so. Below is a list of the
        ...
        <ul>
          ...
          <li>
            * You may change your account and privacy settings. You may change
            or correct information voluntarily submitted to us. We encourage you
            to keep your data current by viewing your settings page.
          </li>
        ...
        <p>
          ...
          for Sentrei Premium Membership from any person under the age of 13. If
          a user submitting personal information is suspected of being younger
          than 13 years of age, Sentrei will prevent user from registering for
          Premium Plan or Package, cancel his/her membership without being
          liable to refund any paid subscription fees, also Sentrei retains the
          right to close such account and or not allow such users to continue
          using Sentrei Service. We will also take steps to delete the
          information as soon as possible.
        </p>
        <p>
          Please notify us if you know of any individuals under the age of 13
          using our Premium Services so we can take action to prevent access to
          our Services.
        </p>
        ...
        <ul>
          <li>
            * We will collect, save and store all information contained in your
            Sentrei chat history for up to 90 days, including your photos, voice
            messages, videos, and sticker. If you are a premium user, you can
            elect to save this information on our servers for a longer period of
            time. You can permanently delete your Sentrei chat history at any
            time.
          </li>
        </ul>
        ...
        <ul>
          ...
          <li>
            * To collect aggregated data from your chat history. We use the data
            to build language models which help us improve the Service. We will
            only collect this data on an aggregated basis, and in a manner which
            does not reveal any personally identifiable information about any
            individual user. We will use this data to help us understand our
            users’ interests, analyze trends, and customize the user experience.
          </li>
        </ul>
        <h2>24. Cross Border Transfers</h2>
        <p>
          To facilitate our global operations, Sentrei may transfer, store, and
          process your information within our family of companies, partners, and
          service providers based throughout the world.
        </p>
        <p>
          ...
          under applicable data protection laws. By communicating electronically
          with Sentrei, you acknowledge and agree to your personal information
        ...
        <p>
          ...
          Mobile App and website, confirms its compliance with the EU-US Privacy
          Shield Framework. We are committed to subjecting all personal
          information received from European Union (EU) member countries, in
          reliance on the Privacy Shield Framework, to the Framework's
          applicable Principles. To learn more about the Privacy Shield
        ...
        <p>
          ...
          transfers to a third party acting as an agent on its behalf. Before we
          share your information with any third party that is not also certified
          under the EU-US Privacy Shield Framework, Sentrei will enter into a
          written agreement that the third party provides at least the same
          level of privacy safeguard as required under those Frameworks, and
          assures the same level of protection for the personal information as
          required under applicable data protection laws.
        </p>
        <p>
          Worldwide data subjects with inquiries or complaints relating to
          Sentrei Privacy Shield internal policy should first contact Sentrei by
          filling the CONTACT US form provided in www.Sentrei.com. If we are
          unable to resolve your complaint or dispute, you may refer your
          complaint to our designated independent dispute resolution mechanism,
          i.e. the International Centre for Dispute Resolution ("ICDR").
        </p>
        ...
        <p>
          ...
          relate to personal data. Sentrei verifies compliance to the principles
          through self-assessment. The privacy policy covering human resources
          data can be accessed on our intranet app site by all employees.
        </p>
        ...
        <p>
          ...
          have the right to object to that use though, in some cases, and this
        ...
        <p>
          ...
          information. These include, but are not limited to, internal reviews
          of: (a) Sentrei’s data collection; (b) storage and processing
          practices; (c) electronic security measures; and (d) physical security
          measures to guard against unauthorized access to systems where Sentrei
          stores personal information. All Sentrei employees, contractors and
          agents who access personal information are bound by confidentiality
          obligations and may be subject to discipline, including termination
          and criminal prosecution or unauthorized use or disclosure of personal
          information.
        </p>
        ...
        <p>
          ...
          components of the Sentrei contents. In either case, such third parties
          may have separate privacy policies and data collection practices,
          independent of Sentrei. Sentrei: (a) has no responsibility or
          liability for these independent policies or actions; (b) is not
          responsible for the privacy practices or the content of such App; and
          (c) does not make any warranties or representations about the
          contents, products or services offered on such App or the security of
          any information you provide to them
        </p>
        ...
        <ul>
          <li>
            * Mobile advertising identifiers are identifiers used by mobile
            ...
            advertising providers to gather metrics on mobile apps (Apple’s IDFA
            or Google’s AAID) to help advertisers provide ads that may be more
        ...
        <ul>
          <li>
            * To deliver content, including ads relevant to your interests, on
            ...
            advertising networks may use advertising identifiers collected from
            your Sentrei Application and website to deliver ads they believe are
            relevant to you in other third party apps.
          </li>
        </ul>
        <h3>Other things you should know:</h3>
        <ul>
          <li>
            * Third party advertisers on the Service can access your IP address
            and mobile advertising identifiers. You can change the mobile
            advertising identifiers in your mobile device or limit advertising
            tracking through your mobile device’s privacy settings.
          </li>
        </ul>
        ...
        <p>
          ...
          not monitor or take any action with respect to these signals or other
          mechanisms.
        </p>
        ...
        <p>
          ...
          several days to process and you will continue to receive transactional
          emails from us (e.g., emails confirming transactions and/or providing
          information about your account).
        </p>
        <h2>33. Data Security</h2>
        <p>
          We are committed to maintaining the security of your personal data and
          have measures in place to protect against the loss, misuse, and
          alteration of the data under our control. We employ modern and secure
          techniques to protect our systems from intrusion by unauthorized
          individuals, and we regularly upgrade our security as better methods
          become available.
        </p>
        <p>
        ...
        <p>
          ...
          processing of personal data are contractually obligated to respect the
          confidentiality of your data and abide by the privacy standards we
          have established. Please be aware that no security measures are
          perfect or impenetrable. Therefore, although we use industry standard
          practices to protect your privacy, we cannot (and do not) guarantee
          the absolute security of personal data.
        </p>
        <p>
          The App may offer chat rooms, Chatbots, forums, message boards, or
          news groups to users. It is important to remember that any information
          disclosed in these areas becomes public information. Accordingly, as
          with any public forum, you should exercise extreme caution when
          deciding whether to disclose your personal information.
        </p>
        ...
        <p>
          ...
          limited accordingly). It is Sentrei's policy to comply with the EU'S
          ...
          to the United States (or other countries) based upon the following
          legal frameworks:
        </p>
        <ul>
          <li>
          ...
          <li>
            * <strong>Consent:</strong> we may transfer your personal
            information when we receive your express, revocable consent. Our use
            of standard contractual clauses (also known as "model clauses")
            where appropriate.
          </li>
          <li>
        ...
        <ul>
          <li>
            <p>
              * <strong>Right of Access:</strong> you have the right to obtain
              ...
              personal data concerning you are being processed, and, where that
              is the case, access to the following personal data and
              information:
            </p>
            <ul>
              ...
              <li>
                ...
                (for a list of supervisory authorities, see
                <a
          ...
          <li>
            * <strong>Right to Rectification:</strong> you have the right to
            ...
            personal data concerned, provided during registration by him or her.
            Taking into account the purposes of the processing, the user have
            the right to have request his incomplete personal data be completed,
          ...
          <li>
            * <strong>Right to Erasure (“Right to be Forgotten):</strong>you
            ...
            data without undue delay when: a) your data are no longer necessary
            for the purposes for which they were collected; b) you had consented
            to the processing; c) you have objected to the processing, as per
            below; d) your persona data had been unlawfully collected; e) your
            personal data need to be erased as a matter of compliance with a
            legal obligation.
          </li>
          <li>
            * <strong>Right to Restriction of Processing:</strong> you have the
            right to obtain from us the restriction of processing if you: a)
            contest the accuracy of the personal data, until this is verified;
            b) the processing is unlawful but you don’t want erasure; c) we no
            longer need the personal data, but you require them to establish,
            exercise to defend a legal claim; d) you have objected to processing
            but there is a need to verify whether our legitimate grounds
            override your rights to object.
          </li>
          <li>
        ...
        <p>
          ...
          provisions. In this case, we can no longer process your personal data
          unless we show that there is a compelling legitimate ground for the
          processing which override your interests, rights and freedoms or for
          our establishment, exercise or defense of legal claims.
        </p>
        <h2>36. Your Right To Withdraw Consent</h2>
        <p>
          Where the processing of your personal information by us is based on
          consent, you have the right to withdraw that consent without detriment
          at any time by contacting us info@Sentrei.co. You can also change your
          marketing preferences. You can also exercise the rights listed above
          at any time by contacting us at info@Sentrei.co. If your request or
          concern is not satisfactorily resolved by us, you may contact our data
          protection officer, his email is info@Sentrei.co
        </p>
        <p>
        ...
        <p>
          ...
          you (found at the bottom of the email) or send an unsubscribe request
          to us at&nbsp;info@Sentrei.co. We will process your request within a
        ...
        <p>
          ...
          with any third party who may use such information for direct marketing
          purposes, then you may opt-out of such disclosures by sending an email
          to&nbsp;info@Sentrei.co. Please note that if you opt out in this
          manner, certain aspects of the App and platform may no longer be
          available to you. We will process your request within a reasonable
          time after receipt.
        </p>
        ...
        <p>
          ...
          out, you will continue to see generic advertising that is not tailored
          to your specific interests and activities. Please note that
          ...
          your device browser, that opt-out will not be effective on your mobile
          device. You must separately opt out on each device. EU residents who
          have provided their consent to our use of cookies and similar
          technologies can use the EDAA’s opt out tool
        </p>
