...
resource "github_branch_protection" "sentrei_alpha" {
  ...
  required_status_checks {
    strict   = true
    contexts = ["auto-approve", "cla", "functions", "labeler", "ui", "yarn", "video", "web", "Terraform Cloud/sentrei/sentrei-alpha", "WIP"]
  }
...
resource "github_branch_protection" "sentrei_beta" {
  ...
  required_status_checks {
    strict   = true
    contexts = ["auto-approve", "cla", "functions", "labeler", "ui", "yarn", "video", "web", "Terraform Cloud/sentrei/sentrei-beta", "WIP"]
  }
...
resource "github_branch_protection" "sentrei_main" {
  ...
  required_status_checks {
    strict   = true
    contexts = ["auto-approve", "cla", "functions", "labeler", "ui", "yarn", "video", "web", "Terraform Cloud/sentrei/sentrei-main", "WIP"]
  }
